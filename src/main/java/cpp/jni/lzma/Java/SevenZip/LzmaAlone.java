package cpp.jni.lzma.Java.SevenZip;
...
public class LzmaAlone
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		if (params.Command == CommandLine.kBenchmak)
		{
			...
			cpp.jni.lzma.Java.SevenZip.LzmaBench.LzmaBenchmark(params.NumBenchmarkPasses, dictionary);
		}
		else if (params.Command == CommandLine.kEncode || params.Command == CommandLine.kDecode)
		{
			...
			{
				cpp.jni.lzma.Java.SevenZip.Compression.LZMA.Encoder encoder = new cpp.jni.lzma.Java.SevenZip.Compression.LZMA.Encoder();
			...
			else
			{
				...
				cpp.jni.lzma.Java.SevenZip.Compression.LZMA.Decoder decoder = new cpp.jni.lzma.Java.SevenZip.Compression.LZMA.Decoder();
